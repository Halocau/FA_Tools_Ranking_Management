...
const EditDecision = () => {
  ...
  const getStepColor = (index) => {
    ...
    if (index === 0 && !isCriteriaSaved) {
      return "default"; // Criteria not save , no tick mark
    }
    if (index === 1 && !isTitleSaved) {
      return "default"; // Title not save , no tick mark
    }
    if (index === 2 && !isTaskSaved) {
      return "default"; // Task not save , no tick mark
    }
    return "secondary"; 
  };
