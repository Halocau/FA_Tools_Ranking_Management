...
public class RankingDecisionService implements IRankingDecisionService {
    ...
    public RankingDecisionService(IRankingDecisionRepository iRankingDecisionRepository,
            IEmployeeRepository iEmployeeRepository, ModelMapper modelMapper,
            IRankingGroupRepository iRankingGroupRepository, IDecisionCriteriaRepository iDecisionCriteriaRepository,
            IDecisionTasksRepository iDecisionTasksRepository, IRankingTitleRepository iRankingTitleRepository,
            IDecisionCriteriaService iDecisionCriteriaService, IDecisionCriteriaService iDecisionTasksService,
            IAccount iAccount, IRankingTitleOptionRepository iRankingTitleOptionRepository,
            IRankingTitleOptionService rankingTitleOptionService, ITaskWagesService taskWagesService,
    ...
    // private void cloneRankingGroups(RankingDecision existingDecision,
    // RankingDecision cloneDecision, Integer createdBy) {
    // if (existingDecision.getRankingGroups() != null) {
    // List<RankingGroup> clonedGroups =
    // existingDecision.getRankingGroups().stream()
    // .map(group -> {
    ...
    public void cloneRankingTitles(RankingDecision existingDecision, RankingDecision cloneDecision) {
        List<RankingTitle> existingTitles = existingDecision.getRankingTitles(); // Giả sử bạn có getter cho danh sách
                                                                                 // RankingTitles trong RankingDecision
    ...
    // @Override
    // @Transactional
    // public RankingDecision cloneRankingDecision(AddCloneRankingDecisionRequest
    // form) {
    // // Find the original RankingDecision
    // RankingDecision existingDecision =
    // iRankingDecisionRepository.findById(form.getDecisionToCloneId())
    // .orElseThrow(() -> new RuntimeException("Ranking Decision not found!"));
    //
    // // Clone the RankingDecision
    // RankingDecision cloneDecision = RankingDecision.builder()
    ...
    // newEmployee.setEmployeeId(generateNewEmployeeId()); // Đảm bảo ID không bị
    // trùng
    ...
    // clonedEmployees.add(iEmployeeRepository.save(newEmployee)); // Lưu vào
    // Persistence Context
    // }
    ...
    // cloneRankingGroups.add(iRankingGroupRepository.save(newRankingGroup)); //
    // Save individually
    // }
    ...
    // for (DecisionCriteria decisionCriteria :
    // existingDecision.getDecisionCriteria()) {
    // DecisionCriteria newCriteria = new DecisionCriteria();
    // newCriteria.setDecisionId(cloneDecision.getDecisionId()); // Liên kết với
    // RankingDecision đã clone
    // newCriteria.setCriteriaId(decisionCriteria.getCriteriaId()); // Sử dụng
    // Criteria ID cũ
    // newCriteria.setWeight(decisionCriteria.getWeight()); // Clone weight
    // clonedCriteriaList.add(iDecisionCriteriaRepository.save(newCriteria)); //
    // Save individually
    // }
    // cloneDecision.setDecisionCriteria(clonedCriteriaList); // Set cloned
    // DecisionCriteria to the cloned RankingDecision
    // }
    //
    ...
    // }
    //
    // return iRankingDecisionRepository.save(cloneDecision); // Save and return the
    // cloned decision
    // }
    //
