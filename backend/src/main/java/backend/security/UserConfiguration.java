...
// userDetailsManager.setUsersByUsernameQuery("Select id,pw,active from accounts
// where id=?");
// userDetailsManager.setAuthoritiesByUsernameQuery("Select id,role from roles
// where id=?");
// return userDetailsManager;
// }
//
...
//// .build();
////
//// UserDetails manager = User.withUsername("manager")// người quản lý trong
// trường
//// .password("{noop}111")//mật khẩu plan test
//// .roles("manager")
//// .build();
...
//
// http.csrf(csrf -> csrf.disable());//csrf: cross site request forgery: giả mạo
// request kiểu thay vì tương tác từ web thì sẽ tương tac bằng tool kiểu như
// postman
// return http.build();
// }
// }
