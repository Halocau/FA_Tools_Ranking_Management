...
public class CatchException {
    ...
    @ExceptionHandler
    public ResponseEntity<ResponseError> accountException(AccountException ex) {//responseEntity trả về 1 entity
    ...
    @ExceptionHandler
    public ResponseEntity<ResponseError> rankingGruopException(RankingGruopException ex) {//responseEntity trả về 1 entity
        // nếu thằng nào có quăng lỗi này ra, là phương thức sẽ đc gọi để bắt nó lại
        ResponseError er = new ResponseError(HttpStatus.NOT_FOUND.value(), ex.getMessage());
        //HttpStatus.NOT_FOUND.value() => 404,
        //ex.getMessage(): hiện ra thông tin lỗi
    ...
    @ExceptionHandler
    public ResponseEntity<ResponseError> exceptionAll(Exception ex) {//responseEntity trả về 1 entity
        // nếu thằng nào có quăng lỗi này ra, là phương thức sẽ đc gọi để bắt nó lại
